...
const DataSource = () => {
  ...
  const changeTimeRange = useCallback(({ target }) => {
    ...
    setTimeRange([past.startOf("day").toDate(), now.endOf("day").toDate()]);
  }, []);
  ...
  return (
    <>
      ...
      <Flex flexDirection={"column"} height="100%">
          ...
          <Box maxWidth={[container.xl]} mx="auto">
            <Navbar.Group>
              ...
              <h4
                style={{
                  margin: 0,
                  maxWidth: columnCount < 2 ? 130 : "initial",
                }}
        ...
        <div
          className="flex-grow"
          style={{ backgroundColor: Colors.LIGHT_GRAY5, position: "relative" }}
        >
          <ResizeSensor
            onResize={(entries) => {
              ...
              >
                <Box px={3}>
                  <Flex alignItems="center" mb={2}>
                    <Box flexGrow={1}>
                      <h5 style={{ margin: 0 }} className={Classes.HEADING}>
                        Fields
                      </h5>
                    </Box>
                    <Box flexShrink={0}>
                    ...
                    {dataSource.fields
                      ...
                      .map((v) => (
                        <Box
                          ...
                          width={`${
                            100 /
                            ((dataSource.fields.length - 1) % 2 === 0 ? 2 : 3)
                          }%`}
                        >
                          <Card style={{ padding: 0 }}>
                            <H5
                              style={{ padding: "6px 12px 0 12px", margin: 0 }}
                            >
                              <Text ellipsize={true}>
                                {v.name} ({v.type})
                              </Text>
                        ...
                        <>
                          <Box>
                            <Button
                              ...
                              text={
                                <Text>
                                  Delete {selectedDataIds.length} selected data
                                </Text>
                              }
